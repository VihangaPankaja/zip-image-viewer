...
try {
  ...
  assert.equal(await page.locator("#percent").textContent(), "11%");
  await page
  ...
  assert.equal(await page.locator("#percent").textContent(), "7%");
  ...
  assert.equal(await page.locator(".card:visible").count(), 3);
  ...
  assert.equal(await blockedPage.locator("#percent").textContent(), "7%");
  console.log(
